        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample07">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <!-- Acces aux internaute authentifié sur le site -->
                    <?php if(connect()): ?>
                        <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="profil.php">Votre compte</a>
                    </li>
                    <?php else: ?>
                    <!-- Acces aux visiteurs lambda, non authentifié sur le site  -->
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li><a class="dropdown-item" href="admin/gestion_users.php">Gestion membres</a></li>
