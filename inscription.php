...
if(isset($_POST['civilite'], $_POST['pseudo'], $_POST['password'], $_POST['confirm_password'], $_POST['email'], $_POST['prenom'], $_POST['nom'], $_POST['adresse'], $_POST['ville'], $_POST['code_postal']))
{
    ...
    if(!isset($error))
    {
        ...
        $_SESSION['valid_inscription'] = "<p class='col-7 bg-success text-white text-center mx-auto p-3'>Félicitation ! Vous êtes maintenant inscrit sur le site. Vous pouvez des à présent vous connecter.'</p>";
